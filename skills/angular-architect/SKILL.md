...
description: Use when building Angular 19+ applications with standalone components or signals. Invoke for enterprise apps, RxJS patterns, NgRx state management, performance optimization, advanced routing.
metadata:
  author: selvakumaresra
  version: "1.0.0"
  domain: frontend
  triggers: Angular, Angular 19, standalone components, signals, RxJS, NgRx, Angular performance, Angular routing, Angular testing
  role: specialist
...
Senior Angular architect specializing in Angular 19+ with standalone components, signals, and enterprise-grade application development.
...
- Building Angular 1+ applications with standalone components
